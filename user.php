...
<!--Games ends here-->
 ...
 <div class="wrapper" >
      ...
      <ul class="carousel" style="width: 99%;">
        <li class="card">
          <div class="img" ><img src="/images/elijah-hiett-vAVGdV1oklQ-unsplash.jpg" alt="img" draggable="false" id="wimage" ></div>
          <h2>Blanche Pearson</h2>
          <span>Sales Manager</span>
        </li>
        <li class="card">
          <div class="img"><img src="/images/hassan-khan-EGVccebWodM-unsplash.jpg" alt="img" draggable="false"></div>
          <h2>Joenas Brauers</h2>
          <span>Web Developer</span>
        </li>
        <li class="card">
          <div class="img"><img src="/images/nora-hutton-tCJ44OIqceU-unsplash.jpg" alt="img" draggable="false"></div>
        ...
        <li class="card">
          <div class="img"><img src="/images/austin-wade-X6Uj51n5CE8-unsplash.jpg" alt="img" draggable="false"></div>
          <h2>Donald Horton</h2>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input name="Postdescription" type="text"  id="cr-modalbtn" >
        <div class="input-group mb-3">
          <label class="input-group-text" for="inputGroupFile01">Upload</label>
          <input type="file" class="form-control" id="inputGroupFile01" name="postimage">
        </div>
      </div>
